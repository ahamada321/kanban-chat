...
@Component({
  selector: 'app-user-mybookings-list-expired',
  templateUrl: './user-mybookings-list-expired.component.html',
  styleUrls: ['./user-mybookings-list-expired.component.scss'],
})
export class UserMyBookingsListExpiredComponent implements OnInit {
