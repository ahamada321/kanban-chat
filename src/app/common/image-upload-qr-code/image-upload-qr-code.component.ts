...
class FileSnippet {
  static readonly IMAGE_SIZE = { width: 400, height: 400 };
...
@Component({
  selector: 'app-image-upload-qr-code',
  templateUrl: './image-upload-qr-code.component.html',
  styleUrls: ['./image-upload-qr-code.component.scss'],
})
export class ImageUploadQrCodeComponent implements OnInit {
  @Input() isMust: boolean;
  @Input() inputImage: string;
  @Input() inputLabel: string = 'Line QRコード画像を選択';
